...
<head>
	...
	<link rel="stylesheet" type="text/css" href="<?=$this->config->item('baseUrl')?>/assets/css/common.css<?=$this->config->item('ver')?>">
	...
	<script type="text/javascript" src="<?=$this->config->item('baseUrl')?>/assets/js/common.js<?=$this->config->item('ver')?>"></script>
